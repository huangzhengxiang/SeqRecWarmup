...
min_sc = 0
min_rating = 4
preprocessed_dataset_path = f'Data\preprocessed\ml-{type}m_min_rating{min_rating}-min_uc{min_uc}-min_sc{min_sc}-splitleave_one_out\dataset.pkl'
...
plt.savefig(f'./Images/ml-{type}m_min_rating{min_rating}_min_uc{min_uc}_min_sc{min_sc}_seqlen_distribution.png')
